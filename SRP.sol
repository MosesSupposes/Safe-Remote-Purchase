...
contract Purchase {
    ...
    /// Abort the purchase and recalim the ether.
    ...
    /// Transaction has to include `2 * value` ehter.
    /// The ehter will be locked until confirmReceived is called.
